...
PROJECT= AG_extspot-v2-bayesian-model-evaluator
SHELL = /bin/sh
...
# Applications
AG_EXTSPOT = AG_extspot-v2-bayesian-model-evaluator
...
exe: makeobjdir $(OBJECTS)
	...
	$(CXX) $(CPPFLAGS) $(ALL_CFLAGS) -o $(EXE_DESTDIR)/$(AG_EXTSPOT) $(OBJECTS_DIR)/*.o $(LIBS)
